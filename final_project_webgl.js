...
function initShaders() {
    shaderPrograms = [
        ...
        createShader("shader-vs", "shader-cooktor"),
        createShader("shader-vs", "shader-disney")
    ];
    ...
    // Phong shading
    shaderPrograms[2].exponentUniform = gl.getUniformLocation(shaderPrograms[2], "uExponent");
    gl.useProgram(shaderPrograms[2]);
    gl.uniform1f(shaderPrograms[2].exponentUniform, 50.0);    

    // Blinn-Phong shading
    shaderPrograms[3].exponentUniform = gl.getUniformLocation(shaderPrograms[3], "uExponent");
    gl.useProgram(shaderPrograms[3]);
    gl.uniform1f(shaderPrograms[3].exponentUniform, 50.0);

    // Microfacet shading
    shaderPrograms[4].iorUniform = gl.getUniformLocation(shaderPrograms[4], "uIOR");
    shaderPrograms[4].betaUniform = gl.getUniformLocation(shaderPrograms[4], "uBeta");
    gl.useProgram(shaderPrograms[4]);
    gl.uniform1f(shaderPrograms[4].iorUniform, 5.0);
    gl.uniform1f(shaderPrograms[4].betaUniform, 0.2);

    // Cook-Torrance shading
    shaderPrograms[5].iorUniform = gl.getUniformLocation(shaderPrograms[5], "uIOR");
    shaderPrograms[5].betaUniform = gl.getUniformLocation(shaderPrograms[5], "uBeta");
    gl.useProgram(shaderPrograms[5]);
    gl.uniform1f(shaderPrograms[5].iorUniform, 5.0);
    gl.uniform1f(shaderPrograms[5].betaUniform, 0.2);

    // Disney Shader shading
    shaderPrograms[6].iorUniform = gl.getUniformLocation(shaderPrograms[6], "uIOR");
    shaderPrograms[6].betaUniform = gl.getUniformLocation(shaderPrograms[6], "uBeta");
    shaderPrograms[6].metallicUniform = gl.getUniformLocation(shaderPrograms[6], "uMetallic");
    shaderPrograms[6].sheenUniform = gl.getUniformLocation(shaderPrograms[6], "uSheen");
    shaderPrograms[6].sheenTintUniform = gl.getUniformLocation(shaderPrograms[6], "uSheenTint");
    shaderPrograms[6].clearCoatUniform = gl.getUniformLocation(shaderPrograms[6], "uClearCoat");
    shaderPrograms[6].clearCoatRoughnessUniform = gl.getUniformLocation(shaderPrograms[6], "uClearCoatRoughness");
    gl.useProgram(shaderPrograms[6]);
    gl.uniform1f(shaderPrograms[6].iorUniform, 5.0);
    gl.uniform1f(shaderPrograms[6].betaUniform, 0.2);
    gl.uniform1f(shaderPrograms[6].metallicUniform, 0.3);
    gl.uniform1f(shaderPrograms[6].sheenUniform, 0.3);
    gl.uniform1f(shaderPrograms[6].sheenTintUniform, 0.3);
    gl.uniform1f(shaderPrograms[6].clearCoatUniform, 0.3);
    gl.uniform1f(shaderPrograms[6].clearCoatRoughnessUniform, 0.3);
